...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`Ảnh cặp đôi\nSố Ảnh: ${link.length}\nSố dư: -1000$ `,attachment: fs.createReadStream(__dirname + "/cache/2.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/2.jpg"), event.messageID); 
