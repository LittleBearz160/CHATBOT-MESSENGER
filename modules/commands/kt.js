...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      ...
      if(money < 2500) api.sendMessage("Bạn cần 2500$ để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 2500})
   var callback = () => api.sendMessage({body:`khoái lắm cơ😼\nSố dư: -2500$`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
